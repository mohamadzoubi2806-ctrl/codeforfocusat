        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="bg-white p-8 rounded-lg mb-8">
              <h2 className="text-3xl font-heading text-foreground mb-8">פרטי התקשרות</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-heading text-xl text-foreground mb-2">אימייל</h3>
                    <a
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-heading text-xl text-foreground mb-2">אינסטגרם</h3>
                    <a
            ...
            <div className="bg-light-red p-8 rounded-lg">
              <h3 className="text-2xl font-heading text-foreground mb-4">ייעוץ חינם</h3>
              <p className="text-lg text-foreground font-paragraph mb-6">
                צור איתנו קשר דרך WhatsApp לקבלת ייעוץ חינם והבנה כיצד נוכל לעזור לך להתכונן למבחן SAT.
              </p>
              <a
                href="https://wa.me/972523825927"
                target="_blank"
          ...
          >
            <h2 className="text-3xl font-heading text-foreground mb-8">שלח הודעה</h2>
